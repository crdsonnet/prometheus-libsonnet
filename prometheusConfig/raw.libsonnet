      ...
      alertmanagers+:
        {
          ...
          HTTPClientConfig+:
            {
              ...
              basic_auth+:
                {
                  ...
                  withUsernameFile(value): { HTTPClientConfig+: { basic_auth+: { username_file: value } } },
                },
                  ...
                  tls_config+:
                    {
                      ...
                      withCa(value): { HTTPClientConfig+: { oauth2+: { tls_config+: { ca: value } } } },
                      ...
                      withCert(value): { HTTPClientConfig+: { oauth2+: { tls_config+: { cert: value } } } },
                      ...
                      withKey(value): { HTTPClientConfig+: { oauth2+: { tls_config+: { key: value } } } },
              ...
              tls_config+:
                {
                  '#withCa': { 'function': { args: [{ default: null, enums: null, name: 'value', type: 'string' }], help: 'Text of the CA cert to use for the targets.' } },
                  withCa(value): { HTTPClientConfig+: { tls_config+: { ca: value } } },
                  '#withCaFile': { 'function': { args: [{ default: null, enums: null, name: 'value', type: 'string' }], help: 'The CA cert to use for the targets.' } },
                  withCaFile(value): { HTTPClientConfig+: { tls_config+: { ca_file: value } } },
                  '#withCert': { 'function': { args: [{ default: null, enums: null, name: 'value', type: 'string' }], help: 'Text of the client cert file for the targets.' } },
                  withCert(value): { HTTPClientConfig+: { tls_config+: { cert: value } } },
                  '#withCertFile': { 'function': { args: [{ default: null, enums: null, name: 'value', type: 'string' }], help: 'The client cert file for the targets.' } },
                  ...
                  '#withKey': { 'function': { args: [{ default: null, enums: null, name: 'value', type: 'string' }], help: 'Text of the client key file for the targets.' } },
                  withKey(value): { HTTPClientConfig+: { tls_config+: { key: value } } },
                  '#withKeyFile': { 'function': { args: [{ default: null, enums: null, name: 'value', type: 'string' }], help: 'The client key file for the targets.' } },
          ...
          withAlertRelabelConfigs(value): { alert_relabel_configs: (if std.isArray(value)
                                                                    then value
                                                                    else [value]) },
          ...
          withAlertRelabelConfigsMixin(value): { alert_relabel_configs+: (if std.isArray(value)
                                                                          then value
                                                                          else [value]) },
          alert_relabel_configs+:
            {
  ...
  global+:
    {
      ...
      withBodySizeLimit(value): { global+: { body_size_limit: value } },
      ...
      withKeepDroppedTargets(value): { global+: { keep_dropped_targets: value } },
      ...
      withLabelLimit(value): { global+: { label_limit: value } },
      ...
      withLabelNameLengthLimit(value): { global+: { label_name_length_limit: value } },
      ...
      withLabelValueLengthLimit(value): { global+: { label_value_length_limit: value } },
      ...
      withSampleLimit(value): { global+: { sample_limit: value } },
      ...
      withScrapeProtocols(value): { global+: { scrape_protocols: (if std.isArray(value)
                                                                  then value
                                                                  else [value]) } },
      ...
      withScrapeProtocolsMixin(value): { global+: { scrape_protocols+: (if std.isArray(value)
                                                                        then value
                                                                        else [value]) } },
      ...
      withTargetLimit(value): { global+: { target_limit: value } },
    },
      ...
      queue_config+:
        {
          ...
          withSampleAgeLimit(value): { queue_config+: { sample_age_limit: value } },
        },
      '#withRemoteTimeout': { 'function': { args: [{ default: null, enums: null, name: 'value', type: 'integer' }], help: '' } },
      withRemoteTimeout(value): { remote_timeout: value },
  ...
  scrape_configs+:
    {
      ...
      withEnableCompression(value=true): { enable_compression: value },
      ...
      '#withKeepDroppedTargets': { 'function': { args: [{ default: null, enums: null, name: 'value', type: 'integer' }], help: 'Keep no more than this many dropped targets per job.\n0 means no limit.' } },
      withKeepDroppedTargets(value): { keep_dropped_targets: value },
      '#withLabelLimit': { 'function': { args: [{ default: null, enums: null, name: 'value', type: 'integer' }], help: 'More than this many labels post metric-relabeling will cause the scrape to\nfail. 0 means no limit.' } },
      ...
      withNativeHistogramBucketLimit(value): { native_histogram_bucket_limit: value },
      ...
      withNativeHistogramMinBucketFactor(value): { native_histogram_min_bucket_factor: value },
      ...
      withScrapeClassicHistograms(value=true): { scrape_classic_histograms: value },
      ...
      withScrapeProtocols(value): { scrape_protocols: (if std.isArray(value)
                                                       then value
                                                       else [value]) },
      '#withScrapeProtocolsMixin': { 'function': { args: [{ default: null, enums: null, name: 'value', type: 'array' }], help: 'The protocols to negotiate during a scrape. It tells clients what\nprotocol are accepted by Prometheus and with what preference (most wanted is first).\nSupported values (case sensitive): PrometheusProto, OpenMetricsText0.0.1,\nOpenMetricsText1.0.0, PrometheusText0.0.4.' } },
      withScrapeProtocolsMixin(value): { scrape_protocols+: (if std.isArray(value)
                                                             then value
                                                             else [value]) },
      ...
      withTrackTimestampsStaleness(value=true): { track_timestamps_staleness: value },
    },
  ...
  tracing+:
    {
      ...
      tls_config+:
        {
          '#withCa': { 'function': { args: [{ default: null, enums: null, name: 'value', type: 'string' }], help: 'Text of the CA cert to use for the targets.' } },
          withCa(value): { tracing+: { tls_config+: { ca: value } } },
          '#withCaFile': { 'function': { args: [{ default: null, enums: null, name: 'value', type: 'string' }], help: 'The CA cert to use for the targets.' } },
          withCaFile(value): { tracing+: { tls_config+: { ca_file: value } } },
          '#withCert': { 'function': { args: [{ default: null, enums: null, name: 'value', type: 'string' }], help: 'Text of the client cert file for the targets.' } },
          withCert(value): { tracing+: { tls_config+: { cert: value } } },
          '#withCertFile': { 'function': { args: [{ default: null, enums: null, name: 'value', type: 'string' }], help: 'The client cert file for the targets.' } },
          ...
          '#withKey': { 'function': { args: [{ default: null, enums: null, name: 'value', type: 'string' }], help: 'Text of the client key file for the targets.' } },
          withKey(value): { tracing+: { tls_config+: { key: value } } },
          '#withKeyFile': { 'function': { args: [{ default: null, enums: null, name: 'value', type: 'string' }], help: 'The client key file for the targets.' } },
